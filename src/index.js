...
const data = {
    ...
    nickname: "sharlybip",
    description: "Ingeniero en Sistemas con gusto por el desarrollo web",
    avatar: "https://pbs.twimg.com/profile_images/689096621716586496/1-fXbtUZ_400x400.jpg",
    social: [
      {
        name: "platzi",
        url: "https://platzi.com/p/",
        username: "Sharlybip",
        svgClass: `w-6 h-6 cursor-pointer text-gray-400 hover:text-[#98CA3F] fill-current" viewBox="0 0 24 24"
        ...
        //     username: "sharlybip",
        //     svgClass: `w-6 h-6 cursor-pointer text-gray-400 hover:text-[#FF0000] fill-current" viewBox="0 0 24 24"
        //     xmlns="http://www.w3.org/2000/svg"`,
        ...
        // },
        {
            ...
            username: "sharlybip",
            svgClass: `w-6 h-6 cursor-pointer text-gray-400 hover:text-[#E4405F] fill-current" role="img"
          ...
          },
          {
            ...
            username: "sharlybip",
            svgClass: `w-6 h-6 cursor-pointer text-gray-400 hover:text-blue-300 fill-current"
          ...
          },
          {
            ...
            username: "carlos-dom%C3%ADnguez-34a62b1a9",
            svgClass: `w-6 h-6 cursor-pointer text-gray-400 hover:text-blue-500 fill-current"
          ...
          },
          {
            ...
            username: "sharlybip",
            svgClass: "w-6 h-6 cursor-pointer text-gray-400 hover:text-[#6e5494] fill-current",
  ...
  const main = () => {
    ...
    let socialMedia = data?.social.map(social => {
      return `
        <a href="${social.url}${social.username}" target="_blank">
        <svg class="${social.svgClass}"
        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
